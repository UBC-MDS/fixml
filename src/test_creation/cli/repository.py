...
class RepositoryActions(object):
    ...
    def evaluate(repo_path: str, save_response_to: str = None,
                 export_report_to: str = None, quarto_export_to: str = None,
                 quarto_export_as: str = 'html', checklist_path: str = None,
                 model="gpt-3.5-turbo", verbose: bool = False,
        ...
        quarto_export_to
            Optional. If provided, the system will export an evaluation report
            rendered via Quarto.
            This relies on Quarto installed in your system.
        quarto_export_as
            Optional. If provided, the quarto evaluation report will be exported
            in the specified format.
            This relies on Quarto installed in your system.
            The format specified must be supported by Quarto.
            Defaults to `html`.
        checklist_path
            Optional flag to use non-default checklist during the operation.
        test_dirs
        ...
        if quarto_export_to:
            renderer = EvalReportRenderer(response_output_path)
            renderer.render(output_path=quarto_export_to,
                            format=quarto_export_as)
