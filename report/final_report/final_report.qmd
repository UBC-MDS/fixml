...
Consistency is another consideration because it directly links to the reliability of the evaluation results from user perspective. As the completeness scores from LLMs contain randomness, we plotted graphs of the uncertainty of completeness scores across checklist items and repositories to show how consistent these results were.
